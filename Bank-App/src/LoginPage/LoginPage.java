    ...
    private void register() {
        try {
            if (Operation.findUser(txtfld_register_tcno.getText()) == null) {
                if (!txtfld_register_name.getText().isEmpty()
                        && !txtfld_register_surname.getText().isEmpty()
                        && !String.valueOf(txtfld_register_password.getPassword()).isEmpty()
                        && !txtfld_register_tcno.getText().isEmpty()) {
